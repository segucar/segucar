...
async function checkLisdeupmo() {
    ...
    $('tbody tr').each((i, tr) => {
        const text = $(tr).text();
        if (text.includes('11907911') || text.includes('11908511') || text.includes('11906564') || text.includes('11908565')) {
...
checkLisdeupmo().catch(console.error);
